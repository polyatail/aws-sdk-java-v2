 ...
 */
@SdkPublicApi
public final class S3CredentialsProvider
    implements AwsCredentialsProvider, SdkAutoCloseable,
               ToCopyableBuilder<S3CredentialsProvider.Builder, S3CredentialsProvider> {

    private static final S3CredentialsProvider DEFAULT_CREDENTIALS_PROVIDER = new S3CredentialsProvider(builder());
     ...
     * @see #builder()
     */
    private S3CredentialsProvider(Builder builder) {
    ...
    /**
     * Create an instance of the {@link S3CredentialsProvider} using the default configuration. Configuration can be
     * specified by creating an instance using the {@link #builder()}.
     */
    public static S3CredentialsProvider create() {
    ...
    /**
     * Get a builder for defining a {@link S3CredentialsProvider} with custom configuration.
     */
    ...
    /**
     * Configuration that defines the {@link S3CredentialsProvider}'s behavior.
     */
    public static final class Builder implements CopyableBuilder<Builder, S3CredentialsProvider> {
        ...
        private Builder(S3CredentialsProvider credentialsProvider) {
        ...
        /**
         * Create a {@link S3CredentialsProvider} using the configuration defined in this builder.
         */
        public S3CredentialsProvider build() {
            return new S3CredentialsProvider(this);
        }
    }
}
